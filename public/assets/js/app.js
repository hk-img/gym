...
$(document).ready(function() {
	...
	if($('.custom-file-container').length > 0) {
        if($('[data-upload-id="myFirstImage"]').length > 0) {
			var firstUpload = new FileUploadWithPreview('myFirstImage');
		}
	
		// Second upload
		if($('[data-upload-id="mySecondImage"]').length > 0) {
			var secondUpload = new FileUploadWithPreview('mySecondImage');
		}

		// Third upload
		if($('[data-upload-id="myThirdImage"]').length > 0) {
			var thirdUpload = new FileUploadWithPreview('myThirdImage');
		}

		// Four upload
		if($('[data-upload-id="myFourImage"]').length > 0) {
			var fourUpload = new FileUploadWithPreview('myFourImage');
		}
	}
