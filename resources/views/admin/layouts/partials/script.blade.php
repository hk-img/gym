{{-- <script data-cfasync="false"
    ...
    <!-- Fileupload JS -->
    <script src="{{asset('assets/plugins/fileupload/fileupload.min.js')}}" type="text/javascript"></script>

    {{-- <script src="{{asset('assets/js/image-uploader.min.js')}}" type="text/javascript"></script> --}}

    <!-- Ckeditor JS -->
    {{-- <script src="{{asset('assets/js/ckeditor.js')}}" type="text/javascript"></script> --}}
    <script src="{{asset('assets/js/ckeditor5.umd.js')}}" type="text/javascript"></script>
