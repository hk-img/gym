        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col d-flex justify-content-end align-items-center">
                    <a href="{{route('admin.category.index')}}"><button type="button" class="btn btn-primary me-2">Back</button></a>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card shadow-lg border-0 rounded-lg">
                    ...
                    <div class="card-body p-4">
                        <form method="POST" action="{{ route('admin.category.update', $data->id) }}" enctype="multipart/form-data" id="myForm">
                            @csrf
                            @method('patch')
