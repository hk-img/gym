                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" name="condition" required>
                                            ...
                                            <option value="New"
                                                {{ old('condition', $equipment->condition) == 'New' ? 'selected' : '' }}>New
                                            </option>
                                            <option value="Good"
                                                {{ old('condition', $equipment->condition) == 'Good' ? 'selected' : '' }}>
                                                Good</option>
                                            <option value="Needs Maintenance"
                                                {{ old('condition', $equipment->condition) == 'Needs Maintenance' ? 'selected' : '' }}>
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="amount"
                                            value="{{ old('amount', $equipment->amount) }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="bill_no"
                                            value="{{ old('bill_no', $equipment->bill_no) }}">
                                        @error('bill_no')
                                            <p class="text-danger text-xs pt-1"> {{ $message }} </p>
                                        @enderror
                                    </div>
