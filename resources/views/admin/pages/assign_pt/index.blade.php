...
@section('page_title', 'Assign PT | List')
@push('custom-style')
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <h3 class="page-title">Assign PT</h3>
                        <ul class="breadcrumb">
                ...
                <div class="col-sm-12">
                    <div class="card mb-0">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Assigned PT List</h4>
                            <div class="col-auto float-end ms-auto">
                                <a href="{{route('admin.assign-pt.create')}}" class="btn btn-sm add-btn"><i class="fa fa-plus"></i> Assign PT</a>
                            </div>
                        </div>
                        <div class="card-body">
...
@push('custom-script')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            initializeDataTable("{{ route('admin.assign-pt.index') }}",filterSelectors, userColumns);
        });
    </script>
@endpush
